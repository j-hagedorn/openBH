...
County15<-select(County15,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=X.4)

x1<-grep("Michigan",County14$X.1)
County14<-County14[x1,]
County14<-select(County14,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=Health.Factors)

x1<-grep("Michigan",County13$X.1)
County13<-County13[x1,]
County13<-select(County13,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=Health.Factors)

x1<-grep("Michigan",County12$X.1)
County12<-County12[x1,]
County12<-select(County12,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=Health.Factors)

x1<-grep("Michigan",County11$X.1)
County11<-County11[x1,]
County11<-select(County11,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=Health.Factors)

x1<-grep("Michigan",County10$X.1)
County10<-County10[x1,]
County10<-select(County10,FIPS=X,County=X.2,"County.Health.Factor.Ranking"=Health.Factors)
