...
dir.create("Obesity.Prevalence")
setwd("~/Obesity.Prevalence")
#2012
...
o12<-select(o12,FIPS=X,Obesity.Prevalence=X2012)
...
o11<-select(o11,FIPS=X,Obesity.Prevalence=X2011)
...
o10<-select(o10,FIPS=X,Obesity.Prevalence=X2010)
...
o09<-select(o09,FIPS=X,Obesity.Prevalence=X2009)
...
o08<-select(o08,FIPS=X,Obesity.Prevalence=X2008)
...
o07<-select(o07,FIPS=X,Obesity.Prevalence=X2007)
...
o06<-select(o06,FIPS=X,Obesity.Prevalence=X2006)
...
o05<-select(o05,FIPS=X,Obesity.Prevalence=X2005)
