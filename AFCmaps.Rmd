...
## Locations
Adult Foster Care homes are spread across the state of Michigan
```{r, echo= FALSE, message=FALSE}
# Load data 
# Read from file
...
## Notes
[^1]: In order to geomap the addresses of residential homes, we [used open source packages](https://github.com/j-hagedorn/openBH/blob/master/code/readAFC.R#L32), if need high level of specificity, we recommend Dale K. Howe Consulting, LLC.
